...
#ifdef RAMDISK
/* Everything is located in /lib instead of /usr/lib. */
#define SHELL		"/bin/sh"
#define PP		"/lib/ncpp"
#define IRREL		"/lib/irrel"
#define CEM		"/lib/ncem"
#define M2EM		"/lib/nm2em"
#define OPT		"/lib/nopt"
#define CG		"/lib/ncg"
#define AS		"/bin/as"
#define LD		"/lib/ld"
...
struct passinfo passinfo[] = {
	{ "cpp", PP, 0, "i", "wo=o,I*,D*,U*", INPUT|STDOUT },
